...
\renewcommand{\title}{Beerbot: Beer Retrieval through Visual Feedback and Probabilistic Roadmaps}
...
\renewcommand{\appendixtocname}{Apéndices}% For spanish title
\renewcommand{\appendixpagename}{Apéndices}% For spanish title
